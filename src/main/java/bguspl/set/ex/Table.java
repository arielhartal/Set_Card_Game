...
public class Table {
    ...
    public Table(Env env, Integer[] slotToCard, Integer[] cardToSlot) {
        ...
        this.tokenToSlot = new Boolean[12][env.config.players];
    }
